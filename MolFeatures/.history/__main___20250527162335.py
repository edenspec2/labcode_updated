...
class MoleculeApp:
    ...
    def build_question_interface(self, parent, questions, loaded_entries=None):
        ...
        Button(
            bottom_frame,
            text="Save input",
            command=lambda: self.save_input_json(entry_widgets, save_as=True)
        ).pack(side='left', padx=5)
    ...
    def on_load_answers(self, questions):
        ...
        loaded_entries = self.load_answers_json(questions)
    ...
    def save_input_json(entry_widgets):
        """
