...
class MoleculeApp:
    def __init__(self, master):
        ...
        self.sidebar_frame_left = customtkinter.CTkFrame(master, width=100,height=300, corner_radius=0)
        self.sidebar_frame_left.grid(row=0, column=0, rowspan=4, sticky="nsew")

        self.sidebar_frame_right = customtkinter.CTkFrame(master, width=140,height=300, corner_radius=0)
        self.sidebar_frame_right.grid(row=0, column=3, rowspan=4, sticky="nsew")
        

        
        self.output_text = Text(master, wrap='none', height=40, width=100)
