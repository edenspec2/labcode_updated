    ...
    def build_question_interface(self, parent, questions, loaded_entries=None):
        ...
        for i, question in enumerate(questions):
            ...
            if question.startswith("Dipole atoms"):
                new_center_atoms_label = Label(frame_q, text="Center Atoms:")
                ...
                entry_widgets["Center Atoms"] = new_center_atoms_entry

                if "Center Atoms" in loaded_entries:
                    new_center_atoms_entry.delete(0, 'end')
                    new_center_atoms_entry.insert(0, loaded_entries["Center Atoms"])
