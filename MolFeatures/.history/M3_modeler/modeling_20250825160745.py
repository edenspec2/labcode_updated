...
class ClassificationModel:
    ...
    def simi_sampler_(self,class_label, compare_with=0, plot=True, sample_size=None):
        ...
        # print indices and molecules names
        print("Selected indices:", self.indices)
        print("Selected molecules:", np.array(self.molecule_names)[self.indices])
