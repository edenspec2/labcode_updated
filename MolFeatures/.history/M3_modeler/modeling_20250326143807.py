        ...
        def evaluate_with_threshold(threshold):
            ...
            if n_jobs == 1:
                ...
                for combination in tqdm(self.features_combinations,
                    ...
                    res = fit_and_evaluate_single_combination_regression(self,combination, threshold,bool_parallel=bool_parallel) # fit_and_evaluate_single_combination_with_prints
                    results.append(res)
            else:
                # Parallel execution
