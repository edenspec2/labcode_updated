...
def plot_all_features_vs_target(features_df, target_vector, molecule_names=None, figsize=(12, 10)):
    ...
    def plot_shap_summary(model, X, feature_names=None, max_display=20, figsize=(12, 8)):
        ...
        try:
            ...
            print("SHAP package not installed. Please install with 'pip install shap'")
            return None
    ...
    def analyze_shap_values(model, X, feature_names=None, target_name="target", n_top_features=10):
        """
