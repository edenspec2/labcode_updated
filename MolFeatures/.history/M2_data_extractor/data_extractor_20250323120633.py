...
def calc_sterimol(bonded_atoms_df,extended_df,visualize=False):
    ...
    max_row=edited_coordinates_df.iloc[edited_coordinates_df['B5'].idxmax()]
    print(edited_coordinates_df, b5_index, b5_point,best_b1_plane)
    L=max(edited_coordinates_df['L'].values)
    loc_B5 = min(edited_coordinates_df['y'].iloc[max_row])
