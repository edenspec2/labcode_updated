...
def preform_coordination_transformation(xyz_df, indices=None, sub_atoms=None):
    """
...
class Molecule():
    ...
    def get_coordination_transformation_df(self, base_atoms_indices: List[int],sub_atoms=None) -> pd.DataFrame:
        """
        ...
        """
        new_coordinates_df = preform_coordination_transformation(self.xyz_df, base_atoms_indices,sub_atoms)
