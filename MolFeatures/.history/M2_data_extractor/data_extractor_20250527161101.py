...
class Molecule:
    ...
    def get_molecule_comp_set_hetro(self,dipole_mode = 'gaussian', radii = 'bondi'):
      ...
      Do you want to compute any angles/dihedrals? y/n: n
        ...
        """
        res=[]
        ring_atom_indices= split_to_pairs(input("Ring atoms - by order -> primary axis (para first), ortho atoms and meta atoms: "))
        gen_vibration_indices= split_to_pairs(input("your atom pairs: "))
        dipole_indices= string_to_int_list(input('Enter atoms - origin atom, y axis atom and xy plane atom: '))
        # nbo_indices=split_to_pairs(input('Insert atom pairs for which you wish calculate differences: '))
        sterimol_indices= string_to_int_list(input('Primary axis along: '))
        indices_for_dist= split_to_pairs(input('Distances - Atom pairs: '))
        ...
        'For example - 1 2 3  1 2 3 4 will give angle(1, 2, 3) and dihedral(1, 2, 3, 4)')
            angle_string= split_for_angles(input('Insert a list of atom triads/quartets for which you wish to have angles/dihedrals: '))
...
class Molecules():
    ...
    #     xyz_dfs=[get_df_from_file(file) for file in xyz_files] 
