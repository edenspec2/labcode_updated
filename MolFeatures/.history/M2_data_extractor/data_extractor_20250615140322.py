...
class Molecules():
    ...
    def get_molecules_comp_set_app(self, entry_widgets, parameters=None, answers_list=None, save_as=False):
        ...
        if answers['npa']:
            # try:
                print(answers['npa'], sub_atoms=answers.get('sub_atoms', []))
                res_df = pd.concat([
                    res_df,
                    dict_to_horizontal_df(
        ...
        if answers['dipole']:
            try:
                ...
                print(f"Error processing dipole for {self.molecules[0].molecule_name}")
                pass
        ...
        if answers['sterimol']:
            try:
                ...
                print(f"Error processing Sterimol for {self.molecules[0].molecule_name}")
                pass
