    ...
    def build_question_interface(self, parent, questions, loaded_entries=None):
        ...
        for i, question in enumerate(questions):
            ...
            if question.startswith("Dipole atoms"):
                new_center_atoms_label = Label(frame_q, text="New Center Atoms:")
                ...
                entry_widgets["New Center Atoms"] = new_center_atoms_entry

                if "New Center Atoms" in loaded_entries:
                    new_center_atoms_entry.delete(0, 'end')
                    new_center_atoms_entry.insert(0, loaded_entries["New Center Atoms"])
            ...
            if question.startswith("NPA manipulation"):
                ...
                if "Sub-Atoms" in loaded_entries:
                    sub_atoms_entry.delete(0, 'end')
                    sub_atoms_entry.insert(0, loaded_entries["Sub-Atoms"])
            ...
            if question.startswith("Strech Vibration atoms"):
