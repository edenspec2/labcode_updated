...
class MoleculeApp:
    def __init__(self, master):
        ...
        self.master.bind_all(
            "<MouseWheel>",
            lambda e: self.output_text.yview_scroll(int(-1 * (e.delta / 120)), "units")
        )
        self.master.bind_all("<Button-4>", lambda e: self.output_text.yview_scroll(-1, "units"))
        self.master.bind_all("<Button-5>", lambda e: self.output_text.yview_scroll( 1, "units"))
