...
class MoleculeApp:
    def __init__(self, master):
        ...
        self.sidebar_frame_left = customtkinter.CTkFrame(
            master, width=140, corner_radius=0
        )
        self.sidebar_frame_left.grid(
            row=0, column=0, rowspan=5, sticky="nsew"
        )

        self.sidebar_frame_right = customtkinter.CTkFrame(
            master, width=140, corner_radius=0
        )
        self.sidebar_frame_right.grid(
            row=0, column=3, rowspan=5, sticky="nsew"
        )

        # — Output textbox with scrollbars —
        ...
        self.v_scrollbar = customtkinter.CTkScrollbar(
            master,
            orientation="vertical",
            command=self.output_text.yview
        )
        self.h_scrollbar = customtkinter.CTkScrollbar(
            master,
        ...
        self.output_text.grid(
            row=0, column=1, rowspan=4, columnspan=1,
            sticky="nsew",
            padx=(10, 0), pady=(10, 0)
        )
        ...
        # — Make middle expandables —
        master.grid_columnconfigure(1, weight=1)
        master.grid_columnconfigure(2, weight=0)  # scrollbar column
        master.grid_rowconfigure((0,1,2,3), weight=1)
        master.grid_rowconfigure(4, weight=0)     # scrollbar row
        ...
        master.bind_class(
            "CTkTextbox", "<Button-4>",
            lambda e: e.widget.yview_scroll(-1, "units")
        )
        master.bind_class(
            "CTkTextbox", "<Button-5>",
            lambda e: e.widget.yview_scroll(1, "units")
